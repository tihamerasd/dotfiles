...
static const char *inc_bright[] = {"xbacklight", "-inc", "10"};
static const char *dec_bright[] = {"xbacklight", "-dec", "10"};
static const char *inc_volume[] = {"amixer", "-q", "sset", "Master", "10%+" };
static const char *dec_volume[] = {"amixer", "-q", "sset", "Master", "10%-" };
static const char *screenshot[] = {"mate-screenshot", "-a" };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_b, 	   spawn,          {.v = inc_bright } },
	{ MODKEY|ShiftMask,             XK_b, 	   spawn,          {.v = dec_bright } },
        { MODKEY|ControlMask,           XK_m,      spawn,          {.v = inc_volume } },
        { MODKEY|ShiftMask,             XK_m,      spawn,          {.v = dec_volume } },
